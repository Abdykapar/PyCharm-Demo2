...
class MyTable(models.Model):
    ...
    Dr = models.DateTimeField('date published')
    ...
    StdSay = models.DecimalField(4,10, default=0)
    StdSoz = models.DecimalField(4,10, default=0)
    StdDil = models.DecimalField(4,10, default=0)
    EA = models.DecimalField(4,10, default=0)
    SonSoz = models.DecimalField(4,10, default=0)
    SonSay = models.DecimalField(4,10, default=0)
    Son = models.DecimalField(4,10, default=0)
    SonDil = models.DecimalField(4,10, default=0)
